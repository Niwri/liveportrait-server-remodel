...
def edit_face_landmarks():
    ...
    try:
        ...
        data['n_frames'] = 1
        data['output_fps'] = 1
        eyes_key = 'c_eyes_lst' if 'c_eyes_lst' in data.keys() else 'c_d_eyes_lst'
        lip_key = 'c_lip_lst' if 'c_lip_lst' in data.keys() else 'c_d_lip_lst'
        data[eyes_key] = [data[eyes_key]]
        data[lip_key] = [data[lip_key]]
